...
class QuizProvider extends ChangeNotifier {
  ...
  Future<void> selectAnswer(int index) async {
    ...
    final timeTaken = DateTime.now().difference(_questionStartedAt ?? DateTime.now()).inSeconds;
  ...
  Future<void> completeQuiz() async {
    _timer?.cancel();
    if (_sessionId != null) {
      await db.sessionDao.completeSession(sessionId: _sessionId!, score: _score);
    }
  }
